<%@include file="../Company/guestheader.jsp" %>
<%-- 
    Document   : student.jsp
    Created on : Feb 28, 2018, 11:45:03 AM
    Author     : ckc
--%>
...
<html>
    ...
    if(request.getParameter("eid")!=null)
    {
             ...
             String insQry="insert into tbl_sponsor(char_id,comp_id,status)values('"+request.getParameter("eid")+"','"+session.getAttribute("compid")+"','1')";
        ...
        <form>
          ...
          <h1 align="center">STUDENT LIST</h1>
            <table border="1"  align="center" cellpadding="8" bgcolor="#fff" width="50%" style="border-radius: 12px;box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19)">
               ...
               <%int i=1;
                String sel1="select * from tbl_charityusers ch inner join tbl_usertype ut on ut.charityuserty_id=ch.charityuserty_id  inner join tbl_place p on p.pl_id=ch.pl_id inner join tbl_district dt on dt.dis_id=p.dis_id where ch.charityuserty_id=8";
                ...
                <tr>
                    ...
                    <td><a href="student_1.jsp?eid=<%=rs1.getString("char_id")%>">SPONSOR</a></td><br>
